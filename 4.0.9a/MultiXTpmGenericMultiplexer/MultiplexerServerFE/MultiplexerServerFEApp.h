/*!	\file	*/
// MultiplexerServerFEApp.h: interface for the CMultiplexerServerFEApp class.
//
//////////////////////////////////////////////////////////////////////
/*
...
#if !defined(MultiplexerServerFE_App_H_Included)
#define MultiplexerServerFE_App_H_Included

#pragma once
class	CMultiplexerServerFELink;

/*!
The main application object
*/
class CMultiplexerServerFEApp : public CMultiXApp  
{
public:
	void OnStartup();
	...
	CMultiplexerServerFEApp(int	Argc,char	*Argv[],std::string	Class);
	virtual ~CMultiplexerServerFEApp();
	...
	CMultiplexerServerFELink *FindReadyLink(int	ForwardMsgCode);
};

#include	"MultiplexerServerFELink.h"

#endif // !defined(MultiplexerServerFE_App_H_Included)
