/*!	\file	*/
// MultiplexerClientFEClientSession.h: interface for the CMultiplexerClientFEClientSession class.
//
//////////////////////////////////////////////////////////////////////
/*
...
#if !defined(MultiplexerClientFE_ClientSession_H_Included)
#define MultiplexerClientFE_ClientSession_H_Included

#pragma once

class	CMultiplexerClientFEApp;
class	CMultiplexerClientFELink;

/*!
	When a new connection is created, the connected CMultiplexerClientFEServerLink or	CMultiplexerClientFEClientLink object 
...
class CMultiplexerClientFEClientSession : public CMultiXSession  
{
public:
	CMultiplexerClientFELink * GetLink();
	void OnLinkConnected(CMultiplexerClientFELink *pLink);
	bool OnNewPartnerMsg(CMultiplexerMsg &PartnerMsg,int	ForwardMsgCode);
	...
	bool CanDelete();
	bool	CheckStatus();
	CMultiplexerClientFEClientSession(CMultiplexerClientFEApp	&Owner);
	virtual ~CMultiplexerClientFEClientSession();
	CMultiplexerClientFEApp	*Owner(){return	(CMultiplexerClientFEApp	*)CMultiXSession::Owner();}

private:
	CMultiXLinkID	m_LinkID;	//!<	the id of the CMultiXLink based instance that created this object.
};
#endif // !defined(MultiplexerClientFE_ClientSession_H_Included)
