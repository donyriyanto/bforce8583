...
// MultiplexerClientFEProcess.cpp: implementation of the CMultiplexerClientFEProcess class.
//
//////////////////////////////////////////////////////////////////////
/*
...
*/
CMultiplexerClientFEProcess::CMultiplexerClientFEProcess(TMultiXProcID	ProcID)	:
	CMultiXProcess(ProcID)
{
	DebugPrint(2,"Created\n");
}

CMultiplexerClientFEProcess::~CMultiplexerClientFEProcess()
{
...
*/
void CMultiplexerClientFEProcess::OnDataReplyReceived(CMultiXAppMsg &ReplyMsg, CMultiXAppMsg &OriginalMsg)
{
...
void CMultiplexerClientFEProcess::OnSendMsgFailed(CMultiXAppMsg &OriginalMsg)
{
	DebugPrint(2,"Send Msg Failed");
}

//!	see CMultiXProcess::OnSendMsgTimedout
void CMultiplexerClientFEProcess::OnSendMsgTimedout(CMultiXAppMsg &OriginalMsg)
{
	DebugPrint(2,"Send Msg TimedOut");
}

//!	see CMultiXProcess::OnSenderEnabled
void CMultiplexerClientFEProcess::OnSenderEnabled()
{
}
