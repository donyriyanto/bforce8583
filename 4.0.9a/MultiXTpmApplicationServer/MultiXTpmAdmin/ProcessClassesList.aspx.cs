...
{
	/// <summary>
	/// Summary description for ProcessClassesList.
	/// </summary>
	public partial class ProcessClassesList : BasicPage
	{
		protected MultiXTpmAdmin.MultiXTpmDB m_DS;
		protected System.Data.DataView ProcessClassesView;
		...
		{    
			...
			this.ProcessClassesView = new System.Data.DataView();
			((System.ComponentModel.ISupportInitialize)(this.m_DS)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.ProcessClassesView)).BeginInit();
			// 
			// m_DS
			// 
			...
			// ProcessClassesView
			// 
			this.ProcessClassesView.Table = this.m_DS.ProcessClass;
			((System.ComponentModel.ISupportInitialize)(this.m_DS)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.ProcessClassesView)).EndInit();
