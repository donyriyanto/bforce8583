...
//	inline	std::string	&Application(){return	m_Application;}	//!<	returns	 a reference to the m_Application member variable. its use is application dependent.
	...
	inline	std::string	&LinkName(){return	m_LinkName;}	//!<	returns a reference to a descriptive name of the link. it can be set at initialization and used later for logging.
