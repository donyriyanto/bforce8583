========================================================================
    ACTIVE TEMPLATE LIBRARY : MultiXTpmATL Project Overview
========================================================================

AppWizard has created this MultiXTpmATL project for you to use as the starting point for
...
_MultiXTpmATL.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_MultiXTpmATL.h)
        GUID definitions                                (_MultiXTpmATL_i.c)
        A type library                                  (_MultiXTpmATL.tlb)
        Marshaling code                                 (_MultiXTpmATL_p.c and dlldata.c)
...
StdAfx.h, StdAfx.cpp
    ...
    named MultiXTpmATL.pch and a precompiled types file named StdAfx.obj.
...
MultiXTpmATLps.vcproj
	...
	dlldata.c, MultiXTpmATL_i.c and MultiXTpmATL_p.c which are required
