...
copy gSoapCalculator\Calculator.wsdl runtime
copy gSoapDimeServer\dime.wsdl runtime\DimeServer.wsdl
copy gSoapEchoServer\EchoServer.wsdl runtime
copy gSoapCalculatorClient\bin\Release\*.exe* runtime
cd runtime

rem Uncomment the following lines if you want to install MultiXTpm as a service

rem %windir%\Microsoft.NET\Framework\v2.0.50727\InstallUtil.exe /u /servicename="MultiXTpmgSoapEnhancer" /displayname="MultiXTpm gSoap Enhancer" "%MultiXTpm%\runtime\MultiXTpmService.exe"
rem %windir%\Microsoft.NET\Framework\v2.0.50727\InstallUtil.exe /servicename="MultiXTpmgSoapEnhancer" /displayname="MultiXTpm gSoap Enhancer" "%MultiXTpm%\runtime\MultiXTpmService.exe"
