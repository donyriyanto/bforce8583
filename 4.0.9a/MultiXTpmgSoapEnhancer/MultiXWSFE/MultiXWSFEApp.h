/*!	\file	*/
// MultiXWSFEApp.h: interface for the CMultiXWSFEApp class.
//
//////////////////////////////////////////////////////////////////////
...
#if !defined(MultiXWSFE_App_H_Included)
#define MultiXWSFE_App_H_Included
...
*/
class CMultiXWSFEApp : public CMultiXApp  
{
public:
	void OnStartup();
	void OnTpmConfiguredLink(CMultiXTpmConfiguredLink &Link);
	CMultiXProcess * AllocateNewProcess(TMultiXProcID ProcID);
	CMultiXWSFEApp(int	Argc,char	*Argv[],std::string	Class);
	virtual ~CMultiXWSFEApp();
...
#endif // !defined(MultiXWSFE_App_H_Included)
