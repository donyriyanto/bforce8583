...
SOAP_SOURCE_STAMP("@(#) CalculatorC.cpp ver 2.7.10 2009-12-01 09:50:32 GMT")
...
SOAP_FMAC3 struct Calculator__MulResponse * SOAP_FMAC4 soap_instantiate_Calculator__MulResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)new struct Calculator__MulResponse[n];
		...
		if (size)
			*size = n * sizeof(struct Calculator__MulResponse);
	}
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct Calculator__MulResponse*)cp->ptr;
}
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_Calculator__MulResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct Calculator__MulResponse %p -> %p\n", q, p));
	*(struct Calculator__MulResponse*)p = *(struct Calculator__MulResponse*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_Calculator__Sub(struct soap *soap, struct Calculator__Sub *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_xsd__double(soap, &a->a);
	soap_default_xsd__double(soap, &a->b);
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_Calculator__Sub(struct soap *soap, const struct Calculator__Sub *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put_Calculator__Sub(struct soap *soap, const struct Calculator__Sub *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_Calculator__Sub);
	if (soap_out_Calculator__Sub(soap, tag, id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_Calculator__Sub(struct soap *soap, const char *tag, int id, const struct Calculator__Sub *a, const char *type)
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_Calculator__Sub), type))
		return soap->error;
	if (soap_out_xsd__double(soap, "a", -1, &a->a, ""))
		return soap->error;
	if (soap_out_xsd__double(soap, "b", -1, &a->b, ""))
...
SOAP_FMAC3 struct Calculator__Sub * SOAP_FMAC4 soap_get_Calculator__Sub(struct soap *soap, struct Calculator__Sub *p, const char *tag, const char *type)
{
	if ((p = soap_in_Calculator__Sub(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC3 struct Calculator__Sub * SOAP_FMAC4 soap_in_Calculator__Sub(struct soap *soap, const char *tag, struct Calculator__Sub *a, const char *type)
{
	short soap_flag_a = 1, soap_flag_b = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct Calculator__Sub *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_Calculator__Sub, sizeof(struct Calculator__Sub), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_Calculator__Sub(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct Calculator__Sub *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_Calculator__Sub, 0, sizeof(struct Calculator__Sub), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_a > 0 || soap_flag_b > 0))
...
SOAP_FMAC5 struct Calculator__Sub * SOAP_FMAC6 soap_new_Calculator__Sub(struct soap *soap, int n)
{	return soap_instantiate_Calculator__Sub(soap, n, NULL, NULL, NULL);
}

SOAP_FMAC5 void SOAP_FMAC6 soap_delete_Calculator__Sub(struct soap *soap, struct Calculator__Sub *p)
{	soap_delete(soap, p);
}

SOAP_FMAC3 struct Calculator__Sub * SOAP_FMAC4 soap_instantiate_Calculator__Sub(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_Calculator__Sub(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_Calculator__Sub, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)new struct Calculator__Sub;
		if (size)
			*size = sizeof(struct Calculator__Sub);
	}
	else
	{	cp->ptr = (void*)new struct Calculator__Sub[n];
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct Calculator__Sub);
	}
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct Calculator__Sub*)cp->ptr;
}
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_Calculator__Sub(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct Calculator__Sub %p -> %p\n", q, p));
	*(struct Calculator__Sub*)p = *(struct Calculator__Sub*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_Calculator__SubResponse(struct soap *soap, struct Calculator__SubResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_xsd__double(soap, &a->Result);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_Calculator__SubResponse(struct soap *soap, const struct Calculator__SubResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put_Calculator__SubResponse(struct soap *soap, const struct Calculator__SubResponse *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_Calculator__SubResponse);
	if (soap_out_Calculator__SubResponse(soap, tag, id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_Calculator__SubResponse(struct soap *soap, const char *tag, int id, const struct Calculator__SubResponse *a, const char *type)
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_Calculator__SubResponse), type))
		return soap->error;
	if (soap_out_xsd__double(soap, "Result", -1, &a->Result, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
SOAP_FMAC3 struct Calculator__SubResponse * SOAP_FMAC4 soap_get_Calculator__SubResponse(struct soap *soap, struct Calculator__SubResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in_Calculator__SubResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC3 struct Calculator__SubResponse * SOAP_FMAC4 soap_in_Calculator__SubResponse(struct soap *soap, const char *tag, struct Calculator__SubResponse *a, const char *type)
{
	short soap_flag_Result = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct Calculator__SubResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_Calculator__SubResponse, sizeof(struct Calculator__SubResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_Calculator__SubResponse(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct Calculator__SubResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_Calculator__SubResponse, 0, sizeof(struct Calculator__SubResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_Result > 0))
...
SOAP_FMAC5 struct Calculator__SubResponse * SOAP_FMAC6 soap_new_Calculator__SubResponse(struct soap *soap, int n)
{	return soap_instantiate_Calculator__SubResponse(soap, n, NULL, NULL, NULL);
}

SOAP_FMAC5 void SOAP_FMAC6 soap_delete_Calculator__SubResponse(struct soap *soap, struct Calculator__SubResponse *p)
{	soap_delete(soap, p);
}

SOAP_FMAC3 struct Calculator__SubResponse * SOAP_FMAC4 soap_instantiate_Calculator__SubResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_Calculator__SubResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_Calculator__SubResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)new struct Calculator__SubResponse;
		if (size)
			*size = sizeof(struct Calculator__SubResponse);
	}
	else
	{	cp->ptr = (void*)new struct Calculator__SubResponse[n];
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct Calculator__SubResponse);
	}
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct Calculator__SubResponse*)cp->ptr;
}
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_Calculator__SubResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct Calculator__SubResponse %p -> %p\n", q, p));
	*(struct Calculator__SubResponse*)p = *(struct Calculator__SubResponse*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_Calculator__Add(struct soap *soap, struct Calculator__Add *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_xsd__double(soap, &a->a);
	soap_default_xsd__double(soap, &a->b);
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_Calculator__Add(struct soap *soap, const struct Calculator__Add *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put_Calculator__Add(struct soap *soap, const struct Calculator__Add *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_Calculator__Add);
	if (soap_out_Calculator__Add(soap, tag, id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_Calculator__Add(struct soap *soap, const char *tag, int id, const struct Calculator__Add *a, const char *type)
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_Calculator__Add), type))
		return soap->error;
	if (soap_out_xsd__double(soap, "a", -1, &a->a, ""))
		return soap->error;
	if (soap_out_xsd__double(soap, "b", -1, &a->b, ""))
...
SOAP_FMAC3 struct Calculator__Add * SOAP_FMAC4 soap_get_Calculator__Add(struct soap *soap, struct Calculator__Add *p, const char *tag, const char *type)
{
	if ((p = soap_in_Calculator__Add(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC3 struct Calculator__Add * SOAP_FMAC4 soap_in_Calculator__Add(struct soap *soap, const char *tag, struct Calculator__Add *a, const char *type)
{
	short soap_flag_a = 1, soap_flag_b = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct Calculator__Add *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_Calculator__Add, sizeof(struct Calculator__Add), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_Calculator__Add(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct Calculator__Add *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_Calculator__Add, 0, sizeof(struct Calculator__Add), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_a > 0 || soap_flag_b > 0))
...
SOAP_FMAC5 struct Calculator__Add * SOAP_FMAC6 soap_new_Calculator__Add(struct soap *soap, int n)
{	return soap_instantiate_Calculator__Add(soap, n, NULL, NULL, NULL);
}

SOAP_FMAC5 void SOAP_FMAC6 soap_delete_Calculator__Add(struct soap *soap, struct Calculator__Add *p)
{	soap_delete(soap, p);
}

SOAP_FMAC3 struct Calculator__Add * SOAP_FMAC4 soap_instantiate_Calculator__Add(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_Calculator__Add(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_Calculator__Add, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)new struct Calculator__Add;
		if (size)
			*size = sizeof(struct Calculator__Add);
	}
	else
	{	cp->ptr = (void*)new struct Calculator__Add[n];
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct Calculator__Add);
	}
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct Calculator__Add*)cp->ptr;
}
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_Calculator__Add(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct Calculator__Add %p -> %p\n", q, p));
	*(struct Calculator__Add*)p = *(struct Calculator__Add*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_Calculator__AddResponse(struct soap *soap, struct Calculator__AddResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_xsd__double(soap, &a->Result);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_Calculator__AddResponse(struct soap *soap, const struct Calculator__AddResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put_Calculator__AddResponse(struct soap *soap, const struct Calculator__AddResponse *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_Calculator__AddResponse);
	if (soap_out_Calculator__AddResponse(soap, tag, id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_Calculator__AddResponse(struct soap *soap, const char *tag, int id, const struct Calculator__AddResponse *a, const char *type)
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_Calculator__AddResponse), type))
		return soap->error;
	if (soap_out_xsd__double(soap, "Result", -1, &a->Result, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
SOAP_FMAC3 struct Calculator__AddResponse * SOAP_FMAC4 soap_get_Calculator__AddResponse(struct soap *soap, struct Calculator__AddResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in_Calculator__AddResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC3 struct Calculator__AddResponse * SOAP_FMAC4 soap_in_Calculator__AddResponse(struct soap *soap, const char *tag, struct Calculator__AddResponse *a, const char *type)
{
	short soap_flag_Result = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct Calculator__AddResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_Calculator__AddResponse, sizeof(struct Calculator__AddResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_Calculator__AddResponse(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct Calculator__AddResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_Calculator__AddResponse, 0, sizeof(struct Calculator__AddResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_Result > 0))
...
SOAP_FMAC5 struct Calculator__AddResponse * SOAP_FMAC6 soap_new_Calculator__AddResponse(struct soap *soap, int n)
{	return soap_instantiate_Calculator__AddResponse(soap, n, NULL, NULL, NULL);
}

SOAP_FMAC5 void SOAP_FMAC6 soap_delete_Calculator__AddResponse(struct soap *soap, struct Calculator__AddResponse *p)
{	soap_delete(soap, p);
}

SOAP_FMAC3 struct Calculator__AddResponse * SOAP_FMAC4 soap_instantiate_Calculator__AddResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_Calculator__AddResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_Calculator__AddResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)new struct Calculator__AddResponse;
		if (size)
			*size = sizeof(struct Calculator__AddResponse);
	}
	else
	{	cp->ptr = (void*)new struct Calculator__AddResponse[n];
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct Calculator__AddResponse);
	}
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct Calculator__AddResponse*)cp->ptr;
}
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_Calculator__AddResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct Calculator__AddResponse %p -> %p\n", q, p));
	*(struct Calculator__AddResponse*)p = *(struct Calculator__AddResponse*)q;
}
