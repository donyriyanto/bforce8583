...
*/
#if !defined(MultiXEchoServer_H_Included)
#define MultiXEchoServer_H_Included
...
#include	<MultiXApp.h>
#define	MultiXEchoServer_SOFTWARE_VERSION	"1.00"

enum	TMultiXEchoServerErrorCodes
{
...
#endif // !defined(MultiXEchoServer_H_Included)
