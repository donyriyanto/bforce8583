...
// ISO8583AuthorizerProcess.cpp: implementation of the CISO8583AuthorizerProcess class.
//
//////////////////////////////////////////////////////////////////////
/*
...
*/
CISO8583AuthorizerProcess::CISO8583AuthorizerProcess(TMultiXProcID	ProcID)	:
	CMultiXProcess(ProcID)
{
	DebugPrint(2,"Created\n");
}

CISO8583AuthorizerProcess::~CISO8583AuthorizerProcess()
{
...
*/
void CISO8583AuthorizerProcess::OnDataReplyReceived(CMultiXAppMsg &ReplyMsg, CMultiXAppMsg &OriginalMsg)
{
...
void CISO8583AuthorizerProcess::OnSendMsgFailed(CMultiXAppMsg &OriginalMsg)
{
	DebugPrint(2,"Send Msg Failed");
}

//!	see CMultiXProcess::OnSendMsgTimedout
void CISO8583AuthorizerProcess::OnSendMsgTimedout(CMultiXAppMsg &OriginalMsg)
{
	DebugPrint(2,"Send Msg TimedOut");
}

//!	see CMultiXProcess::OnSenderEnabled
void CISO8583AuthorizerProcess::OnSenderEnabled()
{
}
