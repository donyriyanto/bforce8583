/*!	\file	*/
// ISO8583IssuerGatewayWSFEApp.h: interface for the CISO8583IssuerGatewayWSFEApp class.
//
//////////////////////////////////////////////////////////////////////
...
#if !defined(ISO8583IssuerGatewayWSFE_App_H_Included)
#define ISO8583IssuerGatewayWSFE_App_H_Included
...
*/
class CISO8583IssuerGatewayWSFEApp : public CMultiXApp  
{
public:
	void OnStartup();
	void OnTpmConfiguredLink(CMultiXTpmConfiguredLink &Link);
	CMultiXProcess * AllocateNewProcess(TMultiXProcID ProcID);
	CISO8583IssuerGatewayWSFEApp(int	Argc,char	*Argv[],std::string	Class);
	virtual ~CISO8583IssuerGatewayWSFEApp();
...
#endif // !defined(ISO8583IssuerGatewayWSFE_App_H_Included)
