...
// ISO8583IssuerGatewayWSFEProcess.cpp: implementation of the CISO8583IssuerGatewayWSFEProcess class.
//
//////////////////////////////////////////////////////////////////////
...
*/
CISO8583IssuerGatewayWSFEProcess::CISO8583IssuerGatewayWSFEProcess(TMultiXProcID	ProcID)	:
	CMultiXProcess(ProcID)
{
	DebugPrint(2,"Created\n");
}

CISO8583IssuerGatewayWSFEProcess::~CISO8583IssuerGatewayWSFEProcess()
{
...
void CISO8583IssuerGatewayWSFEProcess::OnSendMsgFailed(CMultiXAppMsg &OriginalMsg)
{
	DebugPrint(2,"Send Msg Failed");
}

//!	see CMultiXProcess::OnSendMsgTimedout
void CISO8583IssuerGatewayWSFEProcess::OnSendMsgTimedout(CMultiXAppMsg &OriginalMsg)
{
	DebugPrint(2,"Send Msg TimedOut");
}

//!	see CMultiXProcess::OnSenderEnabled
void CISO8583IssuerGatewayWSFEProcess::OnSenderEnabled()
{
}
