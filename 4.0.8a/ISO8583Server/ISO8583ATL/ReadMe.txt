========================================================================
    ACTIVE TEMPLATE LIBRARY : ISO8583ATL Project Overview
========================================================================

AppWizard has created this ISO8583ATL project for you to use as the starting point for
...
_ISO8583ATL.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_ISO8583ATL.h)
        GUID definitions                                (_ISO8583ATL_i.c)
        A type library                                  (_ISO8583ATL.tlb)
        Marshaling code                                 (_ISO8583ATL_p.c and dlldata.c)
...
StdAfx.h, StdAfx.cpp
    ...
    named ISO8583ATL.pch and a precompiled types file named StdAfx.obj.
...
ISO8583ATLps.vcproj
	...
	dlldata.c, ISO8583ATL_i.c and ISO8583ATL_p.c which are required
