...
// ISO8583TestClientProcess.cpp: implementation of the CISO8583TestClientProcess class.
//
//////////////////////////////////////////////////////////////////////
/*
...
*/
CISO8583TestClientProcess::CISO8583TestClientProcess(TMultiXProcID	ProcID)	:
	CMultiXProcess(ProcID)
{
	DebugPrint(2,"Created\n");
}

CISO8583TestClientProcess::~CISO8583TestClientProcess()
{
...
*/
void CISO8583TestClientProcess::OnDataReplyReceived(CMultiXAppMsg &ReplyMsg, CMultiXAppMsg &OriginalMsg)
{
...
void CISO8583TestClientProcess::OnSendMsgFailed(CMultiXAppMsg &OriginalMsg)
{
	DebugPrint(2,"Send Msg Failed");
}

//!	see CMultiXProcess::OnSendMsgTimedout
void CISO8583TestClientProcess::OnSendMsgTimedout(CMultiXAppMsg &OriginalMsg)
{
	DebugPrint(2,"Send Msg TimedOut");
}

//!	see CMultiXProcess::OnSenderEnabled
void CISO8583TestClientProcess::OnSenderEnabled()
{
}
