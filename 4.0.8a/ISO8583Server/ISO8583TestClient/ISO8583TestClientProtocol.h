...
class	CISO8583TestClientMsg
{
public:
	CISO8583TestClientMsg()
	{
		m_pBuf	=	NULL;
	}

	static	CISO8583TestClientMsg	*Import(CMultiXBuffer	&Buf,int	Offset=0,int	Size=0x7fffffff)
	{
		CISO8583TestClientMsg	*Msg	=	new	CISO8583TestClientMsg();
...
class CISO8583TestClientProtocol
{
public:
/*! \brief 
...
public:
	CISO8583TestClientProtocol(TProtocolType	ProtocolType);
	~CISO8583TestClientProtocol();

	virtual	TCompletionCodes GetMessage(CISO8583TestClientMsg **Msg)	=	0;
