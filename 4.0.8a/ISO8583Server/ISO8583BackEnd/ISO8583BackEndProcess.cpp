...
// ISO8583BackEndProcess.cpp: implementation of the CISO8583BackEndProcess class.
//
//////////////////////////////////////////////////////////////////////
/*
...
*/
CISO8583BackEndProcess::CISO8583BackEndProcess(TMultiXProcID	ProcID)	:
	CMultiXProcess(ProcID)
{
	DebugPrint(2,"Created\n");
}

CISO8583BackEndProcess::~CISO8583BackEndProcess()
{
...
*/
void CISO8583BackEndProcess::OnDataReplyReceived(CMultiXAppMsg &ReplyMsg, CMultiXAppMsg &OriginalMsg)
{
...
void CISO8583BackEndProcess::OnSendMsgFailed(CMultiXAppMsg &OriginalMsg)
{
	DebugPrint(2,"Send Msg Failed");
}

//!	see CMultiXProcess::OnSendMsgTimedout
void CISO8583BackEndProcess::OnSendMsgTimedout(CMultiXAppMsg &OriginalMsg)
{
	DebugPrint(2,"Send Msg TimedOut");
}

//!	see CMultiXProcess::OnSenderEnabled
void CISO8583BackEndProcess::OnSenderEnabled()
{
}
