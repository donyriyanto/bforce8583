/*!	\file	*/
// ISO8583BackEndApp.h: interface for the CISO8583BackEndApp class.
//
//////////////////////////////////////////////////////////////////////
/*
...
#if !defined(ISO8583BackEnd_App_H_Included)
#define ISO8583BackEnd_App_H_Included

#pragma once
/*!
The main application object
*/
class CISO8583BackEndApp : public CMultiXApp  
{
public:
	void OnStartup();
	CMultiXSession * CreateNewSession(const	TMultiXSessionID &SessionID);
	CMultiXProcess * AllocateNewProcess(TMultiXProcID ProcID);
	CISO8583BackEndApp(int	Argc,char	*Argv[],std::string	Class);
	virtual ~CISO8583BackEndApp();
...
#endif // !defined(ISO8583BackEnd_App_H_Included)
