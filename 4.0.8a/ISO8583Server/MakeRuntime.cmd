...
copy ISO8583WS.wsdl	runtime
copy ISO8583TestClient\TestFileIn.xml runtime
cd runtime
regsvr32 /s iso8583atld.dll

rem Uncomment the following lines if you want to install MultiXTpm as a service

rem	%windir%\Microsoft.NET\Framework\v2.0.50727\InstallUtil.exe /u /servicename="MultiXTpmISO8583Server" /displayname="MultiXTpm ISO 8583 Server" "%MultiXTpm%\runtime\MultiXTpmService.exe"
rem	%windir%\Microsoft.NET\Framework\v2.0.50727\InstallUtil.exe /servicename="MultiXTpmISO8583Server" /displayname="MultiXTpm ISO 8583 Server" "%MultiXTpm%\runtime\MultiXTpmService.exe"
