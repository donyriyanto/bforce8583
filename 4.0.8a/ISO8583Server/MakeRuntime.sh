...
mkdir runtime
cp bin/ISO8583IssuerGatewayFE* runtime
cp bin/ISO8583IssuerGatewayWSFE* runtime
cp bin/ISO8583AcquirerGatewayFE* runtime
cp bin/ISO8583BackEnd* runtime
cp bin/ISO8583TestClient* runtime
cp bin/ISO8583Authorizer* runtime
cp TpmConfig.xml runtime
cp ISO8583WS.wsdl	runtime
cp ISO8583TestClient/TestFileIn.xml runtime
