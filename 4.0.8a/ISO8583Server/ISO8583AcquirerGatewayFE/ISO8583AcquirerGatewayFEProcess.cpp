...
// ISO8583AcquirerGatewayFEProcess.cpp: implementation of the CISO8583AcquirerGatewayFEProcess class.
//
//////////////////////////////////////////////////////////////////////
/*
...
*/
CISO8583AcquirerGatewayFEProcess::CISO8583AcquirerGatewayFEProcess(TMultiXProcID	ProcID)	:
	CMultiXProcess(ProcID)
{
	DebugPrint(2,"Created\n");
}

CISO8583AcquirerGatewayFEProcess::~CISO8583AcquirerGatewayFEProcess()
{
...
*/
void CISO8583AcquirerGatewayFEProcess::OnDataReplyReceived(CMultiXAppMsg &ReplyMsg, CMultiXAppMsg &OriginalMsg)
{
...
void CISO8583AcquirerGatewayFEProcess::OnSendMsgFailed(CMultiXAppMsg &OriginalMsg)
{
	DebugPrint(2,"Send Msg Failed");
}

//!	see CMultiXProcess::OnSendMsgTimedout
void CISO8583AcquirerGatewayFEProcess::OnSendMsgTimedout(CMultiXAppMsg &OriginalMsg)
{
	DebugPrint(2,"Send Msg TimedOut");
}

//!	see CMultiXProcess::OnSenderEnabled
void CISO8583AcquirerGatewayFEProcess::OnSenderEnabled()
{
}
