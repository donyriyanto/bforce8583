...
{
public:
	CISO8583IssuerGatewayFEMsg()
	{
		m_pBuf	=	NULL;
	}

	static	CISO8583IssuerGatewayFEMsg	*Import(CMultiXBuffer	&Buf,int	Offset=0,int	Size=0x7fffffff)
	{
		CISO8583IssuerGatewayFEMsg	*Msg	=	new	CISO8583IssuerGatewayFEMsg();
	...
	virtual	~CISO8583IssuerGatewayFEMsg()
	{
		if(m_pBuf)
		{
			m_pBuf->ReturnBuffer();
...
class CISO8583IssuerGatewayFEProtocol
{
public:
/*! \brief 
...
public:
	CISO8583IssuerGatewayFEProtocol(TProtocolType	ProtocolType);
	~CISO8583IssuerGatewayFEProtocol();

	virtual	TCompletionCodes GetMessage(CISO8583IssuerGatewayFEMsg **Msg)	=	0;
