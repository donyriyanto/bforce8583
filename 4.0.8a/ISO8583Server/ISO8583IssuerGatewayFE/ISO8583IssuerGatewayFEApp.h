/*!	\file	*/
// ISO8583IssuerGatewayFEApp.h: interface for the CISO8583IssuerGatewayFEApp class.
//
//////////////////////////////////////////////////////////////////////
/*
...
#if !defined(ISO8583IssuerGatewayFE_App_H_Included)
#define ISO8583IssuerGatewayFE_App_H_Included

#pragma once
/*!
The main application object
*/
class CISO8583IssuerGatewayFEApp : public CMultiXApp  
{
public:
	void OnStartup();
	void OnTpmConfiguredLink(CMultiXTpmConfiguredLink &Link);
	CMultiXProcess * AllocateNewProcess(TMultiXProcID ProcID);
	CISO8583IssuerGatewayFEApp(int	Argc,char	*Argv[],std::string	Class);
	virtual ~CISO8583IssuerGatewayFEApp();
...
#endif // !defined(ISO8583IssuerGatewayFE_App_H_Included)
