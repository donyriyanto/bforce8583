...
*/
#if !defined(MultiXEchoClient_H_Included)
#define MultiXEchoClient_H_Included
...
#include	<MultiXApp.h>
#define	MultiXEchoClient_SOFTWARE_VERSION	"1.00"

enum	TMultiXEchoClientErrorCodes
{
...
#endif // !defined(MultiXEchoClient_H_Included)
