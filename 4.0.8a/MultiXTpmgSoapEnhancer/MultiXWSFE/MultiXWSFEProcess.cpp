...
// MultiXWSFEProcess.cpp: implementation of the CMultiXWSFEProcess class.
//
//////////////////////////////////////////////////////////////////////
...
*/
CMultiXWSFEProcess::CMultiXWSFEProcess(TMultiXProcID	ProcID)	:
	CMultiXProcess(ProcID)
{
	DebugPrint(2,"Created\n");
}

CMultiXWSFEProcess::~CMultiXWSFEProcess()
{
...
*/
void CMultiXWSFEProcess::OnDataReplyReceived(CMultiXAppMsg &ReplyMsg, CMultiXAppMsg &OriginalMsg)
{
...
void CMultiXWSFEProcess::OnSendMsgFailed(CMultiXAppMsg &OriginalMsg)
{
	DebugPrint(2,"Send Msg Failed");
}

//!	see CMultiXProcess::OnSendMsgTimedout
void CMultiXWSFEProcess::OnSendMsgTimedout(CMultiXAppMsg &OriginalMsg)
{
	DebugPrint(2,"Send Msg TimedOut");
}

//!	see CMultiXProcess::OnSenderEnabled
void CMultiXWSFEProcess::OnSenderEnabled()
{
}
bool CMultiXWSFEProcess::OnAccepted(std::string &Password)
{
	DebugPrint(2,"Accepted - Class=%s\n",this->ProcessClass().c_str());
	return	true;
}
