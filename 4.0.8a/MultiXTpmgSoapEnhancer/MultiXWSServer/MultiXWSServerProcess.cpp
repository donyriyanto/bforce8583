...
// MultiXWSServerProcess.cpp: implementation of the CMultiXWSServerProcess class.
//
//////////////////////////////////////////////////////////////////////
...
*/
CMultiXWSServerProcess::CMultiXWSServerProcess(TMultiXProcID	ProcID)	:
	CMultiXProcess(ProcID)
{
	DebugPrint(2,"Created\n");
}

CMultiXWSServerProcess::~CMultiXWSServerProcess()
{
...
void CMultiXWSServerProcess::OnSendMsgFailed(CMultiXAppMsg &OriginalMsg)
{
	DebugPrint(2,"Send Msg Failed");
}

//!	see CMultiXProcess::OnSendMsgTimedout
void CMultiXWSServerProcess::OnSendMsgTimedout(CMultiXAppMsg &OriginalMsg)
{
	DebugPrint(2,"Send Msg TimedOut");
}

//!	see CMultiXProcess::OnSenderEnabled
void CMultiXWSServerProcess::OnSenderEnabled()
{
}
bool CMultiXWSServerProcess::OnLoginReq(std::string &Password)
{
	this->Accept("MultiXWSServer");
	return	true;
}
