...
class CMultiplexerServerFEClientLink :
	public CMultiplexerServerFELink,
...
public:
	...
	CMultiplexerServerFEClientLink(TTpmConfigParams	&Params);
	~CMultiplexerServerFEClientLink(void);
