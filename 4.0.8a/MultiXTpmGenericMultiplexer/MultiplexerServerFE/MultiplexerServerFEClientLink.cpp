...
CMultiplexerServerFEClientLink::CMultiplexerServerFEClientLink(TTpmConfigParams	&Params)	:
	CMultiplexerServerFELink(Params,MultiXOpenModeClient),
...
CMultiplexerServerFEClientLink::~CMultiplexerServerFEClientLink(void)
{
	CancelConnectTimer();
}


void CMultiplexerServerFEClientLink::CancelConnectTimer()
{
	if(m_pConnectTimer)
	{
...
CMultiXTimer * CMultiplexerServerFEClientLink::SetTimer(int TimerCode, uint32_t Timeout)
{
...
void CMultiplexerServerFEClientLink::OnTimer(CMultiXTimer *pTimer)
{
...
bool	CMultiplexerServerFEClientLink::OnLinkClosed(void)
{
...
*/
bool CMultiplexerServerFEClientLink::OnConnectFailed(int IoError)
{
...
void CMultiplexerServerFEClientLink::OnLinkConnected(void)
{
	m_ConnectRetries	=	0;
}
