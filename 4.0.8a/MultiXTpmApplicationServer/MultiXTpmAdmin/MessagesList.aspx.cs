...
{
	/// <summary>
	/// Summary description for MessagesList.
	/// </summary>
	public partial class MessagesList : BasicPage
	{
		protected MultiXTpmAdmin.MultiXTpmDB m_DS;
		protected System.Data.DataView MessagesView;
		...
		{    
			...
			this.MessagesView = new System.Data.DataView();
			...
			// MessagesView
			// 
			this.MessagesView.Table = this.m_DS.Message;
