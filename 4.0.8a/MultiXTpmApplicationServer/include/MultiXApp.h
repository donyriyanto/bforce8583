...
public:
	...
	*/
	...
	EXPORTABLE_STL::vector<std::string>	&CommandLineArguments(){return	m_CommandLineArguments;}
private:
	EXPORTABLE_STL::vector<std::string>	m_CommandLineArguments;
...
protected:
	...
	*/
	...
	it enter a 1 minute wait for an event. if the derived class returns true,
	...
	a 1 minute wait for some event to happen. The intention of this call is to enable the derived class to do some
