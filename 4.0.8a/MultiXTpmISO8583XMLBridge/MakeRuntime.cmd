...
rem	%windir%\Microsoft.NET\Framework\v2.0.50727\InstallUtil.exe /u /servicename="MultiXTpmISO8583Gateway" /displayname="MultiXTpm ISO 8583 Gateway" "%MultiXTpm%\runtime\MultiXTpmService.exe"
rem	%windir%\Microsoft.NET\Framework\v2.0.50727\InstallUtil.exe /servicename="MultiXTpmISO8583Gateway" /displayname="MultiXTpm ISO 8583 Gateway" "%MultiXTpm%\runtime\MultiXTpmService.exe"
