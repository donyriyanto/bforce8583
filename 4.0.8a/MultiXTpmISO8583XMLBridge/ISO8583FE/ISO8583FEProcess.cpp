...
// ISO8583FEProcess.cpp: implementation of the CISO8583FEProcess class.
//
//////////////////////////////////////////////////////////////////////
/*
...
*/
CISO8583FEProcess::CISO8583FEProcess(TMultiXProcID	ProcID)	:
	CMultiXProcess(ProcID)
{
	DebugPrint(2,"Created\n");
}

CISO8583FEProcess::~CISO8583FEProcess()
{
...
*/
void CISO8583FEProcess::OnDataReplyReceived(CMultiXAppMsg &ReplyMsg, CMultiXAppMsg &OriginalMsg)
{
...
void CISO8583FEProcess::OnSendMsgFailed(CMultiXAppMsg &OriginalMsg)
{
	DebugPrint(2,"Send Msg Failed");
}

//!	see CMultiXProcess::OnSendMsgTimedout
void CISO8583FEProcess::OnSendMsgTimedout(CMultiXAppMsg &OriginalMsg)
{
	DebugPrint(2,"Send Msg TimedOut");
}

//!	see CMultiXProcess::OnSenderEnabled
void CISO8583FEProcess::OnSenderEnabled()
{
}
