...
public:
	...
	static	CISO8583FEMsg	*Import(CMultiXBuffer	&Buf,int	Offset=0,int	Size=0x7fffffff)
	{
		CISO8583FEMsg	*Msg	=	new	CISO8583FEMsg();
...
public:
	CISO8583FEProtocol(TProtocolType	ProtocolType);
	~CISO8583FEProtocol();

	virtual	TCompletionCodes GetMessage(CISO8583FEMsg **Msg)	=	0;
