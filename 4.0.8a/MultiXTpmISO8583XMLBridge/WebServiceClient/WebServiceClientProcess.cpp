...
// WebServiceClientProcess.cpp: implementation of the CWebServiceClientProcess class.
//
//////////////////////////////////////////////////////////////////////
/*
...
*/
CWebServiceClientProcess::CWebServiceClientProcess(TMultiXProcID	ProcID)	:
	CMultiXProcess(ProcID)
{
	DebugPrint(2,"Created\n");
}

CWebServiceClientProcess::~CWebServiceClientProcess()
{
...
*/
void CWebServiceClientProcess::OnDataReplyReceived(CMultiXAppMsg &ReplyMsg, CMultiXAppMsg &OriginalMsg)
{
...
void CWebServiceClientProcess::OnSendMsgFailed(CMultiXAppMsg &OriginalMsg)
{
	DebugPrint(2,"Send Msg Failed");
}

//!	see CMultiXProcess::OnSendMsgTimedout
void CWebServiceClientProcess::OnSendMsgTimedout(CMultiXAppMsg &OriginalMsg)
{
	DebugPrint(2,"Send Msg TimedOut");
}

//!	see CMultiXProcess::OnSenderEnabled
void CWebServiceClientProcess::OnSenderEnabled()
{
}
