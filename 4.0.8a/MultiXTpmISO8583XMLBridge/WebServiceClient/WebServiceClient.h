...
*/
#if !defined(WebServiceClient_H_Included)
#define WebServiceClient_H_Included
...
#define	WebServiceClient_SOFTWARE_VERSION	"1.00"

enum	TWebServiceClientErrorCodes
{
...
#endif // !defined(WebServiceClient_H_Included)
